...
_STD2026 = BASE / "일위대가DB" / "_공통" / "표준일위대가_2026"
...
LANDSCAPE_ILDAE = BASE / "일위대가DB" / "조경" / "조경표준일위대가_2024.csv"  # 서울시설공단 조경 표준설계 일위대가(2024 하반기 노임)
MULGA_2026 = BASE / "일위대가DB" / "_공통" / "물가정보_2026.csv"  # 물가정보 변동품목(이형철근·형강·전선 등 재료비)
JOJADANG_2026 = BASE / "일위대가DB" / "_공통" / "조달청시설자재_2026.csv"  # 조달청 시설공통자재(토목·건축·기계·전기 재료비)
OUT_XLSX = WORK_DIR / "토목" / "01_화성 청원지구 토목_표준단가산출.xlsx"
OUT_MD = WORK_DIR / "토목" / "01_화성 청원지구 토목_표준단가산출_요약.md"

# 임목파쇄 — 위탁 시장가(ton→㎥ 0.40 환산) · 경비 100% · 01_…토목.XLS 전용
# 근거: 05_내역서/내역서작업/토목/임목파쇄_단가기준_체크리스트.md 시나리오 B
...
def load_ildae_prices() -> list[dict]:
    """일위대가DB/_공통/표준일위대가_2026/표준일위대가_2026_마스터.csv 를 단가 후보로 적재.
