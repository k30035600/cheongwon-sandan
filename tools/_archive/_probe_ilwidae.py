...
IL_FILES = [
    ("미매칭_일위대가산출.xlsx", BASE / "내역서작업" / "_공통" / "미매칭_일위대가산출.xlsx"),
    ("검토_일위대가산출.xlsx", BASE / "내역서작업" / "_공통" / "검토_일위대가산출.xlsx"),
    ("검토_토공_일위대가산출.xlsx", BASE / "내역서작업" / "토목" / "검토_토공_일위대가산출.xlsx"),
    ("검토_공종별_일위대가산출.xlsx", BASE / "내역서작업" / "_공통" / "검토_공종별_일위대가산출.xlsx"),
]
...
def main():
    ...
    # 통합내역 행 범위(01 토목)
    print("=" * 70)
    tok = WORK / "토목" / "01_화성 청원지구 토목_표준단가산출.xlsx"
    if tok.exists():
